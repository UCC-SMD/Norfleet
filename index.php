                        ...
                        <li class="message-preview">
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><strong>Sample User 2</strong>
                                        </h5>
...
<!--                    <ol class="breadcrumb">
                ...
                <!-- /.row -->
                        ...
                        <!-- Area chart that we probably won't use -->
<!--                 <div class="row">
                    <div class="col-lg-12">
...
<!--                     <div class="col-lg-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Another Twitter-like thing!</h3>
                            </div>
                            <div class="panel-body">
